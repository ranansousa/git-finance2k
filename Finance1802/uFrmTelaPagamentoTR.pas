...
type
  TfrmRecebimentoTitulos = class(TForm)
    ...
    PempecMsg: TEvMsgDlg;
    cxBarPesquisaSacado: TcxBarEditItem;
    ...
    procedure cxBarPesquisaSacadoCurChange(Sender: TObject);
  private
...
procedure TfrmRecebimentoTitulos.cxBarPesquisaSacadoCurChange(Sender: TObject);
begin
dbgrdMain.DataSource.DataSet.Locate('CLIENTE',UpperCase(cxBarPesquisaSacado.CurEditValue),[loPartialKey]);
end;

procedure TfrmRecebimentoTitulos.cxbrdtmPesquisaCurChange(Sender: TObject);
begin
 dbgrdMain.DataSource.DataSet.Locate('DOC',cxbrdtmPesquisa.CurEditValue,[loPartialKey]);
end;
