...
uses
  ...
  uFrmEspelhoTP in 'uFrmEspelhoTP.pas' {formEspeloTP},
  ...
  uFrmBaixaFPInternet in 'uFrmBaixaFPInternet.pas' {frmBaixaFPInternet},
  uFuncionarioModel in 'model\uFuncionarioModel.pas',
  uCBDebitoModel in 'model\uCBDebitoModel.pas',
  ...
  uFrmBaixaFPCheque in 'uFrmBaixaFPCheque.pas' {frmBaixaFPCheque},
  ...
  uFrmTituloPagarClone in 'uFrmTituloPagarClone.pas' {frmTituloPagarClone};
...
begin
  ...
  Application.CreateForm(TfrmTituloPagarClone, frmTituloPagarClone);
  Application.Run;
end.
