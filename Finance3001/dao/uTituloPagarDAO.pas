...
uses
  ...
  FireDAC.Comp.DataSet, uTituloPagarHistoricoModel, uTituloPagarHistoricoDAO,
  uTituloPagarCentroCustoModel , uTituloPagarCentroCustoDAO,
  FireDAC.Comp.Client;
...
try
    ...
    cmd := ' SELECT * FROM TITULO_PAGAR '+
           ...
           ' AND (DATA_EMISSAO BETWEEN :pDTINICIO AND :pDTFINAL )' +
