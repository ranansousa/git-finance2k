...
type
  TfrmReciboTR = class(TForm)
    ...
    Panel1: TPanel;
    cxbrdtmPesquisaSacado: TcxBarEditItem;
    ...
    procedure cxbrdtmPesquisaSacadoCurChange(Sender: TObject);
  private
...
procedure TfrmReciboTR.cxbrdtmPesquisaSacadoCurChange(Sender: TObject);
begin
 dbgrd1.DataSource.DataSet.Locate('CLIENTE',UpperCase(cxbrdtmPesquisaSacado.CurEditValue),[loPartialKey]);
end;
