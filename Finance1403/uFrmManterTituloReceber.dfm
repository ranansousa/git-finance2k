object frmManterTituloReceber: TfrmManterTituloReceber
  Left = 0
  Top = 0
  Caption = 'Manuten'#231#227'o de t'#237'tulos a receber'
  ClientHeight = 631
  ClientWidth = 912
  Color = clBtnFace
    ...
    object tbBasica: TcxTabSheet
      ...
      inline frameSacado1: TframeSacado
        ...
        inherited cbbcombo: TComboBox
          ...
          Top = 11
          Width = 250
          OnChange = frameSacado1cbbcomboChange
          ExplicitLeft = 12
          ExplicitTop = 11
          ExplicitWidth = 250
        end
      ...
      inline frameTR1: TframeTR
        ...
        inherited cbbTR: TComboBox
          ...
          Width = 206
          TabOrder = 0
          OnChange = frameTR1cbbTRChange
          OnExit = frameTR1cbbTRExit
          ExplicitLeft = 12
          ExplicitWidth = 206
        end
      end
