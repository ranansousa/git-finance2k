...
{        qryDespesas.ParamByName('DTDATAINICIAL').AsString := FormatDateTime('mm/dd/yyyy', pDataInicial);
        ...
        qryDespesas.ParamByName('DTDATAINICIAL').AsString := FormatDateTime('dd.mm.yyyy', pDataInicial);
        qryDespesas.ParamByName('DTDATAFINAL').AsString := FormatDateTime('dd.mm.yyyy', pDataFinal);
