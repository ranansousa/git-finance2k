object frmBaixaFPCheque: TfrmBaixaFPCheque
  Left = 0
  Top = 0
  Caption = 'Pagamento de t'#237'tulo em cheque'
  ClientHeight = 224
  ClientWidth = 634
  Color = clInfoBk
  ...
  inline frameCheque1: TframeCheque
    ...
    inherited qryChequePorID: TFDQuery
      Top = 16
    end
    inherited qryChequePorNumero: TFDQuery
      Left = 56
      Top = 32
    end
  end
