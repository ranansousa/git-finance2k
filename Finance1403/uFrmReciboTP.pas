...
uses
  ...
  frxDBSet, EExtenso, Vcl.ExtCtrls;
...
type
  TfrmReciboTP = class(TForm)
    ...
    Panel1: TPanel;
    cxbrdtmPesquisaCedente: TcxBarEditItem;
    PempecMsg: TEvMsgDlg;
    ...
    procedure cxbrdtmPesquisaCedenteCurChange(Sender: TObject);
...
procedure TfrmReciboTP.cxbrdtmPesquisaCedenteCurChange(Sender: TObject);
begin
  dbgrd1.DataSource.DataSet.Locate('FORNECEDOR',UpperCase(cxbrdtmPesquisaCedente.CurEditValue),[loPartialKey]);
end;
