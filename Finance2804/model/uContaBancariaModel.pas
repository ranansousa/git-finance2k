...
CREATE TABLE CONTA_BANCARIA (
    ...
    ID_BANCO               VARCHAR(36),
    CONTA_INTERNA          VARCHAR(20) CHARACTER SET ISO8859_1,
    CONTA                  VARCHAR(20),
    AGENCIA                VARCHAR(10),
...
uses
  Windows, Messages, Classes, SysUtils,uContaContabilModel, uBancoModel, uOrganizacaoModel;
...
function TContaBancariaModel.getFFativo: Integer;
begin
   Result := FFativo;
end;
...
function TContaBancariaModel.getFFcontaContabil: TContaContabilModel;
begin
...
procedure TContaBancariaModel.SetFcontaContabil(const Value: TContaContabilModel);
begin
...
procedure TContaBancariaModel.SetFFativo(const Value: Integer);
begin
  FFativo := Value;
end;
