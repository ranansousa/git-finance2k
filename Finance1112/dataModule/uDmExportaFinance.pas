...
//obtendo lancamentos de lista de creditos
    ...
    begin
     {operações
       ...
       transfere do caixa para banco
       transfere do banco para caixa
    ...
    while (not query.Eof) do
       begin
          ...
          pCodigoReduzidoDB :=0;
             ...
             qtdParcelas       := query.FieldByName('PARCELA').AsInteger;
                   ...
                   while not qryTRBHistorico.Eof do begin
                     ...
                     CONTA_CRE   := qryTRBHistorico.FieldByName('CONTA_CRE').AsString;
                      ...
                      begin
                        ...
                        HISTORICO := qryTRBHistorico.FieldByName('HISTORICO').AsString;
                        COMPL := Copy(HISTORICO, 50, (HISTORICO.Length)) + ' ' + qryTRBHistorico.FieldByName('COMPL').AsString;
                        HISTORICO := Copy(HISTORICO, 0, 48) + '#';
