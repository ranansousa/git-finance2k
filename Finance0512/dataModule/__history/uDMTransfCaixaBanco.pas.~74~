...
uses
  ...
  FireDAC.Stan.Param, FireDAC.Stan.Error, FireDAC.DatS, FireDAC.Phys.Intf,uCheque,
 ...
 identificadorTD, descricaoTD, cmdDB, cmdCR, idTD, idCBC,  idTOB, idCedente, idHistorico :string;
  ...
  //parte do credito no banco
   ...
   cmdCR :=' INSERT INTO CONTA_BANCARIA_CREDITO (ID_CONTA_BANCARIA_CREDITO, ID_ORGANIZACAO, IDENTIFICACAO , ID_CONTA_BANCARIA, '+
    ...
    qryCreditoBanco.ParamByName('PDESCRICAO').AsString := descricaoTD + ' IDENT CAIXA ' + identificadorTD ;
...
function TdmTransfCaixaBanco.obterCheque(pIdOrganizacao, pContaBancaria, pIdCheque: string): TChequeModel;
var
cheque : TChequeModel;
