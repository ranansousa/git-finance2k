...
type
 TTRBaixaFPDAO = class
  ...
  public
    ...
    class function deleteTodosPorTRB(value :TTRBaixaFPModel): Boolean;
 //   class function obterPorBaixa(value :TTRBaixaModel): TObjectList<TTRBaixaFPModel>;




//    class function Update(value :TTRBaixaModel): Boolean; //não permite alterar
...
class function TTRBaixaFPDAO.deleteTodosPorTRB(value: TTRBaixaFPModel): Boolean;
var
  qryDelete: TFDQuery;
  sucesso: Boolean;
begin
