...
type
  ...
  public
    ...
    function obterAll(pIdOrganizacao: string; var combo: TComboBox; var listaID: TStringList): boolean;
...
function TframeResponsavel.obterAll(pIdOrganizacao: string; var combo: TComboBox; var listaID: TStringList): boolean;
var
