object dmRelRecebimentos: TdmRelRecebimentos
      ...
      item
        ...
        SQL.Strings = (
          ...
          'case'
            ...
            '        when (TR.id_tipo_status in ('#39'QUITADO'#39', '#39'PARCIAL'#39')) then ' +
            'TRB.valor_pago'
          
            '        when (TR.id_tipo_status in ('#39'ABERTO'#39')) then  TR.VALOR_NO' +
            'MINAL'
          ...
          ''
            ...
            'BER = TR.ID_TITULO_RECEBER AND TRB.ID_ORGANIZACAO = TR.ID_ORGANI' +
            'ZACAO)'
          ' '
          ...
          ''
            ...
            '  LEFT OUTER JOIN SACADO C ON (C.ID_SACADO = TR.ID_SACADO) AND (' +
            'C.ID_ORGANIZACAO = TR.ID_ORGANIZACAO)')
      end>
    Connection = dmConexao.conn
    Params = <>
    Macros = <>
  ...
  object qryRelPagamentos: TFDQuery
    ...
    SQL.Strings = (
      ...
      '  C.NOME AS NOME_SACADO,'
      '  T.DESCRICAO AS STATUS,'
      '  CC.DESCRICAO AS CENTRO_DE_CUSTO_PRINCIPAL,'
      '  CC.DESCRICAO AS CENTRO_DE_CUSTO'
      '  '
      'FROM'
      '  TITULO_RECEBER TR'
      ...
      item
        ...
        SQL.Strings = (
          ...
          'FROM  TITULO_RECEBER TR'
            ...
            'ER = TR.ID_TITULO_RECEBER AND TRB.ID_ORGANIZACAO = TR.ID_ORGANIZ' +
            'ACAO)'
          ' '
