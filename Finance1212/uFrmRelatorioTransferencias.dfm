object frmRelatorioTransferencias: TfrmRelatorioTransferencias
  ...
  object frxRelatorioTRF: TfrxReport
    ...
    ReportOptions.LastChange = 43810.488100104170000000
  ...
  object exportMail: TfrxMailExport
    FileName = 'D:\TESTE.PDF'
    UseFileCache = True
    ShowProgress = True
    OverwritePrompt = False
    DataOnly = False
    Address = 'ranansousa@gmail.com'
    Subject = 'TESTE SUBJECT'
    Lines.Strings = (
      'teste do lines')
    ShowExportDialog = True
    FromMail = 'imap@pempec.com.br'
    FromName = 'IMAP'
    Signature.Strings = (
      'teste signature')
    SmtpHost = 'mail.pempec.com.br'
    SmtpPort = 587
    Login = 'ranansousa@gmail.com'
    Password = 'hf3810'
    UseIniFile = True
    TimeOut = 60
