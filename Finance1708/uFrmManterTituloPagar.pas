...
type
  ...
  private
   ...
   msg,  pIDusuario :string;
    ...
    function obterIndiceListaPorDOC(pDOC: string): Integer; //retorna o index do combo onde tem o documento
  ...
  begin
    ...
    begin
     try
        ...
        end else begin sucesso := TTituloPagarDAO.Update(tituloPagarModel); end;
