...
pSite, pString, sep, tk,codi,insc,lic, serhd, sercli, respostaSite : string;
 ...
 begin
  ...
  pSite := 'http://pempec.com.br/validator/?entrada='+pString;
 ...
 org.FVersao := GetVersionInfo(Application.ExeName);
  ...
  begin
    ...
    begin
      ...
      begin
        IdHTTP1.Get('http://pempec.com.br/validator/inserirversao.php?versao=FNC@' + org.FVersao);
