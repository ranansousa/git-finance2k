...
uses
  ...
  FireDAC.Phys.Intf, FireDAC.DApt.Intf, FireDAC.Stan.Async, FireDAC.DApt, uFrmManterHistorico,
...
begin
 ...
 msgStatusBar(3, 'CTRL + F12 carrega todos os títulos - F5 manutenção de histórico.'  + uutil.TOrgAtual.getOrganizacao.FSigla);
...
if frameResponsavel1.cbbcombo.ItemIndex >0 then begin
 ...
 end else begin PempecMsg.MsgInformation('Selecione um responsável.'); end;
