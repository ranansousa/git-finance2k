...
uses
  ...
  FireDAC.Comp.DataSet, FireDAC.Comp.Client,   uTipoCedenteModel, uTipoCedenteDAO, uOrganizacaoDAO, uOrganizacaoModel;
...
begin
  ...
  if not query.IsEmpty then begin
    ...
    try
      ...
      model.FtipoConta              := query.FieldByName('TIPO_CONTA_BANCARIA').AsString;
...
begin
  ...
  try
     ...
     cmdSql := ' INSERT  INTO CEDENTE (ID_CEDENTE, ID_ORGANIZACAO, ID_BANCO, ' +
                    ...
                    ' NOME, CPFCNPJ, PERSONALIDADE, AGENCIA, CONTA_BANCARIA,TIPO_CONTA_BANCARIA, CODIGO, STATUS, '+
                    ...
                    '         :PNOME, :PCNPJ, :PPERSONALIDADE, :PAGENCIA, :PCONTA,:PTIPO_CONTA_BANC, :PCODIGO, :PSTATUS, '+
          ...
          qry.ParamByName('PTIPO_CONTA_BANC').AsString  := value.FtipoConta;
          ...
          if value.FtipoConta = EmptyStr then
          begin
             qry.ParamByName('PTIPO_CONTA_BANC').AsString  := 'C';
          end;
...
begin
  ...
  try
     ...
     cmdSql :=     ' UPDATE CEDENTE '  +
                          ...
                          '     AGENCIA =             :PAGENCIA,'+
                          '     ID_BANCO =            :PIDBANCO,'+
                          '     TIPO_CONTA_BANCARIA = :PTIPO_CONTA_BANC,'+
                          '     CGA =                 :PCGA,'+
