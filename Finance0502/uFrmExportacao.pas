...
begin
  ...
  if qdtTP > 0 then begin
      ...
      loMostraErros.Add('Existem titulos em aberto no período informado.', False, True);
      ...
      loMostraErros.Add(' Efetue a baixa do(s) título(s) ou altera a data de VENCIMENTO. ', True, True);
