   ...
   for D := 0 to baixa.listaDeducao.Count -1 do begin
       ...
       deducao     := baixa.listaDeducao[D];
        ...
        try
            ...
            raise Exception.Create('Erro ao tentar inserir dedução');
          end;
      ...
      // INTERNET BANK
       ...
       if TTPBaixaFPDAO.Insert(formaPagto) then begin
          ...
          try
            ...
            raise Exception.Create('Erro ao tentar lancçar o débito na conta bancária');
          end;
      ...
      if baixa.listaFormasPagto[FP].FFormaPagamento.FID.Equals('ESPECIE') then begin
        ...
        begin
          ...
          try
            ...
            raise Exception.Create('Erro ao tentar lancçar o débito na tesouraria ');
          end;
