...
uses
  ...
  FireDAC.Comp.Client, Vcl.Grids, Vcl.DBGrids, uFrameOrganizacoes,  uTPBaixaModel, uTPBaixaDAO,
    ...
    if listaTP.Count > 0 then begin
      ...
      for I := 0 to listaTP.Count -1  do begin
        try
          ...
          raise Exception.Create('Não foi possível deletar o TP ' + listaTP[I].FnumeroDocumento );
