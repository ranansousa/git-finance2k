  ...
  object qryPreencheGrid: TFDQuery
    ...
    SQL.Strings = (
      ...
      'FROM CONTA_BANCARIA CB'
        ...
        '   INNER JOIN BANCO B ON (CB.ID_BANCO = B.ID_BANCO) AND (CB.ID_O' +
        'RGANIZACAO = B.ID_ORGANIZACAO)'
      
        '   INNER JOIN CONTA_CONTABIL CC ON (CB.ID_CONTA_CONTABIL = CC.ID' +
        '_CONTA_CONTABIL) AND (CB.ID_ORGANIZACAO = CC.ID_ORGANIZACAO)'
      ''
