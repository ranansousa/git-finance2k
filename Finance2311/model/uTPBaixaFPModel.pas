...
interface
 ...
 type
  ...
  private
    ...
    function getFFIDformaPagamento: string;
    procedure SetFFIDformaPagamento(const Value: string);


  public

    property FIDformaPagamento: string              read getFFIDformaPagamento   write SetFFIDformaPagamento;
...
function TTPBaixaFPModel.getFFIDformaPagamento: string;
begin
Result := FFIDformaPagamento;
end;
...
procedure TTPBaixaFPModel.SetFFIDformaPagamento(const Value: string);
begin
