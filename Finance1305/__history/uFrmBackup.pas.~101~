...
uses
  ...
  IdIOHandlerStack, IdSSL, IdSSLOpenSSL, EMsgDlg, FireDAC.Stan.Option,
  FireDAC.Stan.Param, FireDAC.DatS, FireDAC.Phys.Intf, FireDAC.DApt.Intf,
  FireDAC.Stan.Async, FireDAC.DApt, Data.DB, FireDAC.Comp.DataSet,
  FireDAC.Comp.Client, dxSkinsCore, dxSkinsDefaultPainters, cxGraphics,
...
//            uUtil.GetUserFromWindows + ' ?') = 6 then
  ...
  begin
    lblAviso.Caption :=   'Pempec Enterprise Backup  - Operação concluída. Aguarde a tela fechar... ';
    Application.ProcessMessages;
     sleep(10000);
     Label1.Caption := cap;
//    Application.Terminate;
...
begin
  lblAviso.Caption := '';
    ...
    freeAndNilDM(Self);
  try
    lblAviso.Caption := 'Operação iniciada...';
