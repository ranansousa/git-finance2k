...
uses
  ...
  uDMExportaFinanceTPB,
   uDMTituloPagarBaixaDeducao, UDMTituloPagarBaixaAcrescimo,UDMTituloReceberBaixaAcrescimo,
...
type
  TdmRelExportacaoMega = class(TDataModule)
    ...
    provbase_1606: TFDQuery;
    provDB_1606: TFDQuery;
    provCR_1606: TFDQuery;
...
begin
  ...
  raise Exception.Create('Erro ao obter historico do TP');
