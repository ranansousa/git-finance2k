...
begin
  listaTPAberto := TObjectList<TTituloPagarModel>.Create;
  listaTPAberto.Clear;
  listaTPAberto := TTituloPagarDAO.obterTodosPagar(pDataInicial, pDataFinal, idOrganizacao);
...
begin
  ...
  if obterChequesEmitidos(idOrganizacao) then begin
     Inc(chequesEmtidos);
     if chequesEmtidos = 1 then begin
