...
limpaStatusBar;
 ...
 if not uutil.Empty(idCheque) then begin
     ...
     dxStatusBarEstorna.Panels[1].Text :=' Operação realizada em espécie. Saque em banco. ' ;
