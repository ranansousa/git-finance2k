...
uses
  Windows, Messages, Classes, SysUtils, uEstadoModel, uCidadeModel, uBairroModel;
...
type
  ...
  FFBairro  :TBairroModel;
    ...
    procedure SetFFemailSuporte(const Value: string);
  ...
  public
    ...
    property FemailSuporte :string  read FFemailSuporte write SetFFemailSuporte;
    ...
    property Fvinculada            :Boolean read FFvinculada        write FFvinculada   ;
    property FEstado            :TEstadoModel read FFEstado        write FFEstado   ;
    property FCidade            :TCidadeModel read FFCidade        write FFCidade   ;
    property FBairro            :TBairroModel read FFBairro        write FFBairro   ;
...
procedure TOrganizacaoModel.SetFFemailSuporte(const Value: string);
begin
  FFemailSuporte := Value;
end;
