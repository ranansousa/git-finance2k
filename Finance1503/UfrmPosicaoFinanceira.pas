...
//tela que pode ser exibida quando o sistema é carregado
//mostra saldo das contas; total de dividas e creditos
//utiliza o parametro exibePanel := dmParametros.obterStatusTela('TA011');
//chamada no formPrincipal
