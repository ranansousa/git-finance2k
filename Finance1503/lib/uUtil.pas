...
//    class procedure setId(UserId: string);
    class procedure setId(UserId: Integer);
    ...
    class function getUserId: Integer;
  ...
  public
    ...
    class function getDemontrativoRDConsolidado:string;
    class function getDemontrativoRDConsXLS:string;
...
class function TUserAtual.getUserId: Integer;
begin
...
class procedure TUserAtual.setId(UserId: Integer);
begin
  FIdUser := UserId;
end;
...
class function TPathRelatorio.getDemontrativoRDConsolidado: string;
begin
 Result :=  getPathRelatorios + 'relDemonstrativoRDConsolidado.fr3';
 //exibe resultados por mes
end;

class function TPathRelatorio.getDemontrativoRDConsXLS: string;
begin
 Result :=  getPathRelatorios + 'relDemonstrativoRDConsXLS.fr3';
end;
