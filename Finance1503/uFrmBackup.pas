...
uses
  ...
  uUtil,  FireDAC.Comp.UI, FireDAC.Phys.FB, VCLUnZip, VCLZip,
  Vcl.Buttons, uVarGlobais, Vcl.Samples.Spin, udmConexao, Vcl.StdCtrls, Vcl.StdActns,
  ...
  IdTCPClient, FireDAC.Phys, uBrowseForFolderU, cxLookAndFeels,
  cxLookAndFeelPainters, dxStatusBar, dxRibbonSkins, dxSkinsCore,
  dxSkinsDefaultPainters, dxRibbonCustomizationForm;
...
//            uUtil.GetUserFromWindows + ' ?') = 6 then
  ...
  dmConexao.conectarBanco;
  limpaStatusBar;
  msgStatusBar(1,'Último arquivo de Backup : ' + arquivoBackup + ' gerado em : '+   DateToStr(Now) + ' ' + hora );
