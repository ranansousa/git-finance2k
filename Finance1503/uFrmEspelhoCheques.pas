...
begin
  ...
  begin
    ...
    PempecMsg.MsgInformation('Não foi possível emitir a cópia de cheque.');
...
begin
  ...
  begin
    ...
    begin
      ...
      localFile := GetCurrentDir + '\rel\bancos\'; //informa a pasta onde o arquivo será gravado
...
begin
 ...
 __contaBancaria := dbgrdMain.DataSource.DataSet.FieldByName('ID_CONTA_BANCARIA').AsString;
  ...
  begin
    ...
    begin
      if NOT cheque.FIDtipoStatus.Equals('BLOQUEADO') then begin
