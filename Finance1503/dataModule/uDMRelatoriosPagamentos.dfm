      ...
      item
        ...
        SQL.Strings = (
          ...
          ''
            ...
            '-- LEFT OUTER JOIN TITULO_PAGAR_RATEIO_CC TPC ON (TPC.ID_TITULO_' +
            'PAGAR = TP.ID_TITULO_PAGAR  AND TPC.ID_ORGANIZACAO = TP.ID_ORGAN' +
            'IZACAO)'
          ''
          ...
          ''
            ...
            '-- retirado em 11/08/20 pq trazia varios  LEFT OUTER JOIN TITULO' +
            '_PAGAR_HISTORICO TPH ON (TPH.ID_TITULO_PAGAR = TP.ID_TITULO_PAGA' +
            'R  AND TPH.ID_ORGANIZACAO = TP.ID_ORGANIZACAO)'
          ''
