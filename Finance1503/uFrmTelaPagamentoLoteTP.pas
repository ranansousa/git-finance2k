...
begin
 libera := True;
 { desativado em 08/05 para ver  o  motivo disso
...
//        SavePlace := dbgrdMain.SelectedRows.Items[I].GetBookmark;

      //  SavePlace := dbgrdMain.DataSource.DataSet.GetBookmark;
//        dbgrdMain.SelectedRows.Items[I].


///        GotoBookmark(pointer(dbgrdMain.SelectedRows.Items[I]));
         GotoBookmark(dbgrdMain.SelectedRows.Items[I]);
  ...
  begin
    ...
    PempecMsg.MsgWarning('Não é possível gerar lote com apenas 1 título. ');
    dxBtnFechar.Click;
