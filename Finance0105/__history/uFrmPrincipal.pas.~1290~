...
uses
  ...
  cxCheckBox, dxBarExtItems,uFrmInfoUpdate,System.RegularExpressions  ;
...
dxStatusBar1.Panels[6].Text := 'Internet : Sem conexão.  ' +  'Versão licenciada : ' + uUtil.TOrgAtual.getFFLICENCA;
 ...
 //if 1=1 then   begin
    ...
    begin
      ...
      try
        try
          versaoWeb := IdHTTP1.Get('https://pempec.com.br/validator/obterversao.php?sistema=finance');
    ...
    begin
      ...
      begin
        ...
        orgBD.FVersao := GetVersionInfo(Application.ExeName);
         ...
         TOrganizacaoDAO.ajustarVersao(orgBD);
