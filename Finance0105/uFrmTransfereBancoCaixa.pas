...
begin
  ...
  if dmTransfBancoCaixa.qryObterCBD.RecordCount >0 then begin
        ...
        begin
          PempecMsg.MsgError('Relatório template não encontrado. Contate o Administrador do sistema.');
        end
        else
        begin
...
begin
  ...
  if validarData = 1  then   begin // a data do movimento é maior que a data de hoje
    ...
    PempecMsg.MsgError(' A data do movimento não pode ser maior que a data de hoje...');
         ...
         try
                ...
                begin
                  ...
                  begin
                    ...
                    begin
                       PempecMsg.MsgInformation('Lançamentos excluídos com sucesso.');
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        pIdCheque := FslistaIdCheque[frameCheque1.cbbCheque.ItemIndex];
        validarForm;
      end;
    end
    else
...
begin
 ...
 edtContaContabilCR.Clear;
    ...
    limpaStatusBar;
    cxpgcntrlPGTRFBCOCAIXA.ActivePageIndex :=0;
