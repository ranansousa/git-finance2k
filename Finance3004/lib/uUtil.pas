...
System.UITypes, System.RegularExpressions,   Vcl.Graphics, FireDAC.Stan.Param, jpeg, Organizacao,
...
begin
 if FsVersaoWeb = EmptyStr then uutil.TOrgAtual.getVersao;
  Result := FsVersaoWeb;
end;
...
begin
  FsVersaoWeb := lsVersion;
    if FsVersaoWeb ='' then FsVersaoWeb := '0';
end;
...
begin
  try
    try
      ...
      idMsg.From.Name                  := 'Aplicacao teste';
      ...
      idMsg.Recipients.EMailAddresses   := 'ranansousa@gmail.com'; //  ADestino;
      idMsg.CCList.EMailAddresses       := 'ranan@pempec.com.br';
      idMsg.BccList.EMailAddresses      := sBccList;
      idMsg.BccList.EMailAddresses      := 'ranan@pempec.com.br'; //Cópia Oculta
