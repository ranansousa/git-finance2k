...
try
    ...
    cedente.FIDorganizacao := qryObterCedente.FieldByName('ID_ORGANIZACAO').AsString;
    cedente.FID            := qryObterCedente.FieldByName('ID').AsString;
    cedente.Fnome          := qryObterCedente.FieldByName('NOME').AsString;
    cedente.FcpfCnpj       := qryObterCedente.FieldByName('CPFCNPJ').AsString;
    cedente.FCodigo        := qryObterCedente.FieldByName('CODIGO').AsString;
