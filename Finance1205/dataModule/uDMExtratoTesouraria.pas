  ...
  begin
    ...
    begin
      ...
      begin
        ...
        pDetalhe := qryObterTC.FieldByName('DESCRICAO').AsString + ' ' + qryObterTC.FieldByName('DSC_HIST').AsString + '  IDENT.  ' + qryObterTC.FieldByName('NUMERO_DOCUMENTO').AsString + ' ' + qryObterTC.FieldByName('DOCUMENTO').AsString + ' ' + qryObterTC.FieldByName('DSC_TITULO').AsString + ' ';

        cheque := qryObterTC.FieldByName('CHEQUE_RECEBIDO').AsString;

        if (not uutil.Empty(cheque)) then
        begin

          pDetalhe := qryObterTC.FieldByName('DESCRICAO').AsString + ' ' + qryObterTC.FieldByName('DSC_HIST').AsString + '  IDENT.  ' + qryObterTC.FieldByName('NUMERO_DOCUMENTO').AsString + ' ' + qryObterTC.FieldByName('DOCUMENTO').AsString + ' ' + qryObterTC.FieldByName('DSC_TITULO').AsString + ' ' + qryObterTC.FieldByName('CHEQUE_RECEBIDO').AsString + ' LOTE DEPOSITO > ' + qryObterTC.FieldByName('LOTE').AsString;
    ...
    if qryObterTD.RecordCount > 0 then
    begin
      qryObterTD.First;
      while (not qryObterTD.Eof) do
      begin
        ...
        pDetalhe := qryObterTD.FieldByName('DESCRICAO').AsString + '  IDENT  ' + qryObterTD.FieldByName('NUMERO_DOCUMENTO').AsString + ' ' + qryObterTD.FieldByName('DSC_DOC').AsString + ' ' + qryObterTD.FieldByName('FORNECEDOR').AsString + '  ';
