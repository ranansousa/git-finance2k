...
//     FFNotaFiscalEmitida  :
    ...
    procedure SetFFIDTituloReceberAnterior(const Value: string);
    ...
    procedure SetFFIDNotaFiscalEmitida(const Value: string);
 ...
 property FIDNotaFiscalEmitida:string read FFIDNotaFiscalEmitisa  write SetFFIDNotaFiscalEmitida ;
 ...
 property FisProvisao:Integer read FFisProvisao  write SetFFisProvisao ;
...
procedure TTituloReceberModel.AdicionarCC(  pCentroCusto: TTituloReceberCentroCustoModel);
var
 I: Integer;
 begin
  FSlistaCustos.Add(TTituloReceberCentroCustoModel.Create);
  ...
  FSlistaCustos[I].FIDTR          := pCentroCusto.FIDTR;
  FSlistaCustos[I].FValor         := pCentroCusto.FValor;

 end;

procedure TTituloReceberModel.AdicionarHST(  pHistorico: TTituloReceberHistoricoModel);
var
 I: Integer;
 begin

  FSlistaHistorico.Add(TTituloReceberHistoricoModel.Create);
  ...
  FSlistaHistorico[I].FIDTR                   := pHistorico.FIDTR;
...
procedure TTituloReceberModel.SetFFIDLoteRecebimento(const Value: string);
begin
...
procedure TTituloReceberModel.SetFFIDNotaFiscalEmitida(const Value: string);
begin
  FFIDNotaFiscalEmitisa := Value;
end;
...
procedure TTituloReceberModel.SetFFIDTituloReceberAnterior(const Value: string);
begin
  FFIDTituloReceberAnterior := Value;
end;

procedure TTituloReceberModel.SetFFIDUsuario(const Value: Integer);
begin
  FFIDUsuario := Value;
end;

procedure TTituloReceberModel.SetFFisProvisao(const Value: Integer);
begin
  FFisProvisao := Value;
end;
