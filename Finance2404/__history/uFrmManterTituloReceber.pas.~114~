...
begin
 ...
 //objetos
  ...
  ced.FID := tituloReceberModel.FIDSacado;
  ced := TSacadoDAO.obterPorID(ced);
  tituloReceberModel.FSacado := ced;
...
TPHModel : TTituloReceberHistoricoModel;begin
