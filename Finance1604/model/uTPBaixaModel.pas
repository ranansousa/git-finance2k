...
type
  ...
  private
    ...
    FListaFormasPagto  : TObjectList<TTPBaixaFPModel>; //coleção de  formas pagamentos realizados
...
var
 ...
 begin
  ...
  FlistaAcrescimo[acI].FIDtituloPagarBaixa := pAcrescimo.FIDtituloPagarBaixa;
...
procedure TTPBaixaModel.SetFFIDusuario(const Value: Integer);
begin
  FFIDusuario := Value;
end;
