...
uses
  ...
  dxSkinsDefaultPainters, dxRibbonCustomizationForm, dxStatusBar,
  dxRibbonStatusBar, cxClasses, dxRibbon, Vcl.PlatformDefaultStyleActnCtrls,
  System.Actions, Vcl.ActnList, Vcl.ActnMan, dxBar, cxButtons, ACBrCalculadora,
  dxBarApplicationMenu, cxCalendar, sMaskEdit, sCustomComboEdit, sCurrEdit,
  cxCalc, dxDateTimeWheelPicker, cxBarEditItem, cxContainer, cxEdit, uFrmAjustaSkin,
  dxWheelPicker, dxNumericWheelPicker ;
...
type
  TFrmPrincipal = class(TForm)
    ...
    procedure dxBtnRelDemoCentroCustoClick(Sender: TObject);
...
procedure TFrmPrincipal.dxBtnRelDemoCentroCustoClick(Sender: TObject);
begin
...
//  acessoMenu(false);
  ...
  skm.Active := True;
      //seta o skin definido no config.ini
