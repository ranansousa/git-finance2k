...
begin
  ...
  try
   ...
   idUsuario :=  IntToStr(uutil.TUserAtual.getUserId);
   tipoLanc := 'D';
            ...
            begin
              ...
              cmdCheque := ' UPDATE CONTA_BANCARIA_CHEQUE ' + ' SET ID_TIPO_STATUS = ''COMPENSADO'', ' + ' VALOR = :PVALOR , ' +
                ...
                qryUpdateCheque.ExecSQL;
                 ...
                 Result := False;
                raise Exception.Create('Erro ao alterar dados do cheque ' + cheque.FNumero );
                end;
   ...
   //insere CBD
    ...
    try
      ...
      if not (uUtil.Empty(pIDCheque)) then  begin
        ...
        qryCBD.ParamByName('PDESCRICAO').AsString := pDescricao + ' CH ' + cheque.FNumero;
      end;
    ...
    try
      ...
      qryTC.ParamByName('PIDUSUARIO').AsString := IntToStr(uutil.TUserAtual.getUserId);
      ...
      if not (uUtil.Empty(pIDCheque)) then  begin
       qryTC.ParamByName('PDESCRICAO').AsString := pDescricao + ' CH ' + cheque.FNumero;
      end;
