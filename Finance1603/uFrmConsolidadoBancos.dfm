object frmConsolidadoBancos: TfrmConsolidadoBancos
  Left = 0
  Top = 0
  ...
  object frxRelatorioSaldos: TfrxReport
    ...
    ReportOptions.LastChange = 44257.470261169000000000
  ...
  object qryAnos: TFDQuery
    ...
    SQL.Strings = (
      'SELECT '
      ''
      'extract(year from MAX(CBD.DATA_MOVIMENTO)) as MAIOR ,'
      'extract(year from MIN(CBD.DATA_MOVIMENTO)) as MENOR'
      ''
      ''
  ...
  object qryConsolidadoBancos: TFDQuery
    Active = True
    Connection = dmConexao.conn
    ...
    SQL.Strings = (
      ...
      'from'
      '  sp_saldo_bancario(:PANO,:PIDORGANIZACAO) c'
      'group by'
      '  c.conta_banco_dsc'
      'order by'
      '  c.conta_banco_dsc')
  ...
  object dsConsolida: TDataSource
    DataSet = qryConsolidadoBancos
    Left = 80
    Top = 296
  end
