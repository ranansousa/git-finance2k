...
uses
  ...
  uFrmConsolidadoBancos in 'uFrmConsolidadoBancos.pas' {frmConsolidadoBancos},
  ...
  uFrmEspelhoCheques in 'uFrmEspelhoCheques.pas' {frmEspelhoCheques},
  ...
  uFrmManterCentroCusto in 'uFrmManterCentroCusto.pas' {frmManterCentroCusto},
  ...
  uPempecExceptions in 'lib\uPempecExceptions.pas',
  uMostrarLogErro in 'uMostrarLogErro.pas' {frmMostrarLogErro},
  uDownload in 'lib\uDownload.pas',
  uFrmEnviaMail in 'uFrmEnviaMail.pas' {frmEnviaMail},
  uFrmDemonstrativoDespesasCC in 'uFrmDemonstrativoDespesasCC.pas' {frmDemonstrativoDespesasCC},
  uFrmGerarCheques in 'uFrmGerarCheques.pas' {frmGerarCheques},
  uConstantes in 'lib\uConstantes.pas',
  uFrmTelaSenha in 'uFrmTelaSenha.pas' {frmTelaSenha},
  uFrmManterBanco in 'uFrmManterBanco.pas' {frmManterBanco},
  uFrmManterHistorico in 'uFrmManterHistorico.pas' {frmManterHistorico},
  uFrmConsolidadoCC in 'uFrmConsolidadoCC.pas' {frmConsolidadoCC};
...
begin
  ...
  Application.CreateForm(TfrmTelaSenha, frmTelaSenha);
  Application.Run;
end.
