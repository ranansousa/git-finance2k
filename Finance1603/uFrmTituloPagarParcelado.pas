...
begin
  ...
  iDTP := dmConexao.obterNewID;
      ...
      tituloPagar.FIDusuario              := IntToStr(uutil.TUserAtual.getUserId);
...
I :=0;
 ...
 //criar a colecao de TP com base nas infs do DBGRID
  ...
  begin
    ShowMessage('Não foi possível salvar provisão. A lista está vazia.');
...
end else begin ShowMessage('A parcela não pode ser menor que 1'); edtQtdParcelas.Text := '1';  end;
end;
