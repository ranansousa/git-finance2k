...
type
  ...
  private
    ...
    function getFFsuperAdm: string;
    procedure SetFFsuperAdm(const Value: string);
    ...
    property FsuperAdm :string read getFFsuperAdm   write SetFFsuperAdm   ;
...
function TUsuarioModel.getFFsuperAdm: string;
begin
Result := FFsuperAdm;
end;
...
procedure TUsuarioModel.SetFFsuperAdm(const Value: string);
begin
