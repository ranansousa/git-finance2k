...
begin
  Result :=  ExtractFilePath(Application.ExeName) + 'relHistoricos.fr3';
end;

class function TPathRelatorio.getPagtoCedenteDetalhado: string;
begin
 Result := ExtractFilePath(Application.ExeName) + 'relTitulosPorCedenteDetalhado.fr3';
end;
...
begin
  Result :=  ExtractFilePath(Application.ExeName) + 'relSaldoContasPorMEs.fr3';
end;
