...
uses
  ...
  uFrameContato in 'frames\uFrameContato.pas' {Frame2: TFrame},
  ...
  uFrameImobilizado in 'frames\uFrameImobilizado.pas' {Frame1: TFrame},
  ...
  uFrameCentroCusto in 'frames\uFrameCentroCusto.pas' {Frame3: TFrame};
