...
interface
 ...
 ID_TITULO_PAGAR                VARCHAR(36) NOT NULL,
    ...
    IS_PROVISAO                    SMALLINT,  NAO FOI INSERIDO NO 2k. testes
...
uses
  Windows, Messages, Classes, SysUtils,uContaContabilModel, uHistoricoModel,uTipoCobrancaModel,
   uFuncionarioModel, uLocalPagamentoModel,uLotePagamentoModel, uTipoStatusModel, uCentroCustoModel, uNotaFiscalEntradaModel,
   uLoteContabilModel,uUsuarioModel, uContaBancariaChequeModel,uCedenteModel, uOrganizacaoModel;
...
type
  ...
  private
    ...
    FFIDCBChequeVinculado: string; // ID do cheque vinculado ao titulo. nome da função para vincular
