...
type
  ...
  private
    ...
    procedure SetFFContaBancariaCredito(const Value: TContaBancariaModel);
  ...
  public
    ...
    property FdataMovimento: TDateTime read FFdataMovimento write FFdataMovimento;
...
procedure TTesourariaDBModel.SetFFIDContaContabilCredito(const Value: string);
begin
...
procedure TTesourariaDBModel.SetFFIDUsuario(const Value: string);
begin
  FFIDUsuario := Value;
end;
