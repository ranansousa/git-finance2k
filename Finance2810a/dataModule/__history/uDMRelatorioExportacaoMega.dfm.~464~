object dmRelExportacaoMega: TdmRelExportacaoMega
  ...
  object frxRelatorioExportacaoMega: TfrxReport
    ...
    ReportOptions.LastChange = 43749.723106805560000000
  ...
  object qryTRFCAIXABANCO: TFDQuery
    ...
    SQL.Strings = (
      ...
      '        CB.AGENCIA,'
      '        CCC.CONTA AS CONTA_CONTABIL_DB,'
      '        CCC.CODREDUZ AS COD_REDUZ_DB,'
      '        CCC.DESCRICAO AS DSC_CC_DB,'
      '        TOB.descricao AS TIPO_OPERACAO,'
      '        TOB.codigo AS TOB_CODIGO,'
      '        TOB.id_conta_contabil,'
      '        CCD.CONTA AS CONTA_CONTABIL_CR,'
      '        CCD.CODREDUZ AS COD_REDUZ_CR,'
      '        CCD.DESCRICAO AS DSC_CC_CR,'
