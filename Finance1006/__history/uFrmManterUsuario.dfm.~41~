object frmManterUsuario: TfrmManterUsuario
  ...
  object dbgrd1: TDBGrid
    ...
    Columns = <
      ...
      item
        ...
        FieldName = 'FANTASIA'
        Title.Alignment = taCenter
        Title.Caption = 'ORGANIZA'#199#195'O'
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -11
        Title.Font.Name = 'Tahoma'
  ...
  object qryPreencheGrid: TFDQuery
    ...
    SQL.Strings = (
        ...
        'SELECT U.NOME, U.LOGIN, U.ID_USUARIO, U.ID_ORGANIZACAO, O.FANTAS' +
        'IA'
      ''
      'FROM USUARIO U'
      
        'LEFT OUTER JOIN ORGANIZACAO O ON (O.ID_ORGANIZACAO = U.ID_ORGANI' +
        'ZACAO)'
      ''
      'WHERE 1=1 '
      ''
