...
//    qryAtualizaDescricaoConta.ParamByName('pDataRegistro').AsString := FormatDateTime('mm/dd/yyyy', Now);
    ...
    raise Exception.Create('Não foi possível atualizar a conta contabil.');
  end;
...
begin
  ...
  try
    ...
    raise Exception.Create('Não foi possível inserir a conta contabil.');
  end;
...
begin
 ...
 try
  ...
  qryObterPorConta.Open();
    ...
    raise Exception.Create('Não foi possível obter a conta por filtro...')
  end;
...
begin
 ...
 try
  ...
  qryObterPorCodigoReduzido.Open();
    ...
    raise Exception.Create('Não foi possível obter a conta por CODREDUZ ');
  end;
...
begin
 ...
 try
  ...
  qryObterPlanoContas.Last;
    ...
    raise Exception.Create('Não foi possível obter a  listagem de contas ');
  end;
