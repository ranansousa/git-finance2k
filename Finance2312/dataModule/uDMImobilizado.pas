...
begin
   ...
   try
    ...
    sqlCmd :=   ' INSERT INTO CBENS_PERMANENTE (ID, EMPRESA, GRUPO, CODIGO, DATAAQ, VALORAQ, '+
                ...
                ' VALUES (:PID,:PEMPRESA, :PGRUPO,:PCODIGO, :PDATAAQ, :PVALORAQ, '+
                ' :PDESCRICAO, :PCTDESTCM, :PCTDESTDP, :PCTPARTCM, :PCTPARTDP, :PTIPO, 0, 0, :PCTDESTCM_LEI11638, '+
                ' :PCTPARTCM_LEI11638, :PCTDESTDP_LEI11638, :PCTPARTDP_LEI11638 ) ' ;
    ...
    pID := obterIDBem(pEMPRESA);
    pCODIGO := obterCodigoBem(pEMPRESA);

    qryCadastro.ParamByName('PID').AsInteger := pID;
