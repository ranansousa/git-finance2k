...
uses
  ...
  EMsgDlg, cxButtonEdit, MDDAO, uOrganizacaoDAO, uOrganizacaoModel,uFrmManterUsuario  ;
...
type
  TFrmPrincipal = class(TForm)
    ...
    procedure dxBtnRelLotePagamentoClick(Sender: TObject);
...
begin
 ...
 if not usuario.FloginAutomatico then //vai processar o login normal
  begin
    userValidado := False;
...
procedure TFrmPrincipal.dxBtnRelLotePagamentoClick(Sender: TObject);
begin
...
begin
  if ((Shift = [ssCtrl]) and (Key = VK_F10)) then begin
