...
sucesso := False;
  ...
  try
    ...
    chequeCompensar := TContaBancariaChequeModel.Create;
    chequeCompensar.FID              := value.FID;
    chequeCompensar.FIDorganizacao   := value.FIDorganizacao;
    chequeCompensar.FIDcontaBancaria := value.FIDcontaBancaria;
    chequeCompensar.FIDtipoStatus    := 'COMPENSADO';
    chequeCompensar.FdataCompensacao := value.FdataCompensacao;
