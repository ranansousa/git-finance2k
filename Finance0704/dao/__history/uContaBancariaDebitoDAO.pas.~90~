...
uses
  ...
  uContaBancariaDBModel,uTipoOperacaoBancariaModel,uFuncionarioModel,uTituloPagarModel,uContaBancariaChequeModel,uLoteContabilModel,uUsuarioModel,
  uTipoOperacaoBancariaDAO,uFuncionarioDAO,uTituloPagarDAO,uContaBancariaChequeDAO,uLoteContabilDAO,uUsuarioDAO,
...
begin
  ...
  try
    ...
    begin
      ...
      contaDB.FIDusuario        := query.FieldByName('ID_USUARIO').AsString;
      ...
      contaDB.Fusuario.FID        := StrToInt(contaDB.FIDusuario);
