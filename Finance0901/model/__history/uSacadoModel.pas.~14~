...
function TSacadoModel.getFFcga: string;
begin
  Result := FFcga;
end;
...
function TSacadoModel.getFFIDcartaoCreditoModel: string;
begin
...
function TSacadoModel.getFFinscricaoMunicipal: string;
begin
...
procedure TSacadoModel.SetFcga(const Value: string);
begin
  FFcga := Value;
end;
...
procedure TSacadoModel.SetFIDcartaoCreditoModel(const Value: string);
begin
...
procedure TSacadoModel.SetFinscricaoMunicipal(const Value: string);
begin
