...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.StdCtrls, ENumEd, uUtil, Data.DB,
  cxGraphics, cxControls, cxLookAndFeels, cxLookAndFeelPainters, dxSkinsCore,
  dxSkinsDefaultPainters, FireDAC.Stan.Intf, FireDAC.Stan.Option, uChequeModel,uFrmBaixaFPCheque,
  FireDAC.Stan.Param, FireDAC.Stan.Error, FireDAC.DatS, FireDAC.Phys.Intf,
  FireDAC.DApt.Intf, FireDAC.Comp.DataSet, FireDAC.Comp.Client, dxStatusBar,
...
type
  ...
  public
    { Public declarations }
  constructor Create (AOwner :TComponent; pValorDevido :Currency);
...
constructor TfrmBaixaFP.Create(AOwner: TComponent; pValorDevido: Currency);
begin
