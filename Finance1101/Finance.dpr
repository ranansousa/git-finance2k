...
uses
  ...
  uChequeModel in 'model\uChequeModel.pas',
...
begin
  ...
  Application.CreateForm(TfrmBaixaFPCheque, frmBaixaFPCheque);
  Application.CreateForm(TfrmReciboTP, frmReciboTP);
  Application.CreateForm(TdmBaixaTP, dmBaixaTP);
  Application.Run;
end.
