...
type
 ...
 public
    ...
    property FIDTOB: string read FFIDTOB write FFIDTOB;
    property FIDTP: string read FFIDTP write FFIDTP;
    property FtipoLancamento: string read FFtipoLancamento write FFtipoLancamento;
    ...
    property FpagtoLote :Boolean  read FFpagtoLote       write FFpagtoLote;
