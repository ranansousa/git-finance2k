object dmEspelhoTP: TdmEspelhoTP
  ...
  object qryBaixaTPCaixa: TFDQuery
    Connection = dmConexao.conn
    SQL.Strings = (
      ' SELECT td.ID_TITULO_PAGAR_BAIXA,TD.ID_ORGANIZACAO,'
      '          td.id_organizacao,'
  ...
  object qryTPBAcrescimos: TFDQuery
    Connection = dmConexao.conn
    SQL.Strings = (
      'SELECT TPBA.id_titulo_pagar_baixa, TPBA.ID_ORGANIZACAO,'
      '       TPBA.valor as VALOR, '
      '       TA.descricao,'
      '       TA.id_historico, '
      '       H.descricao as dsc_hist, '
  ...
  object qryTPBDeducao: TFDQuery
    ...
    FormatOptions.FmtDisplayDate = 'DD/MM/YYYY'
    SQL.Strings = (
      'SELECT TPBD.id_titulo_pagar_baixa, TPBD.ID_ORGANIZACAO,'
      '       TPBD.valor as VALOR, '
      '       TD.descricao,'
      '       TD.id_historico, '
      '       H.descricao as dsc_hist, '
  ...
  object frxEspelhoTP: TfrxReport
    ...
    ReportOptions.LastChange = 44020.361560034690000000
