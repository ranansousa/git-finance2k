object fmTelaImpressaoLotePagamento: TfmTelaImpressaoLotePagamento
  ...
  object qryPreencheDBGrid: TFDQuery
    ...
    object qryPreencheDBGridID_LOTE_PAGAMENTO: TStringField
    ...
    object qryPreencheDBGridLOTE: TStringField
      FieldName = 'LOTE'
      Origin = 'LOTE'
      Size = 30
    end
    object qryPreencheDBGridID_ORGANIZACAO: TStringField
    ...
    object qryPreencheDBGridDATA_PAGAMENTO: TDateField
      FieldName = 'DATA_PAGAMENTO'
      Origin = 'DATA_PAGAMENTO'
      Required = True
      DisplayFormat = 'DD/MM/YYYY'
    end
    object qryPreencheDBGridVALOR: TBCDField
      FieldName = 'VALOR'
      Origin = 'VALOR'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    ...
    object qryPreencheDBGridSTATUS: TStringField
      FieldName = 'STATUS'
      Origin = 'STATUS'
      Size = 30
    end
    object qryPreencheDBGridQTD: TIntegerField
      FieldName = 'QTD'
      Origin = 'QTD_TIT_PAG'
      DisplayFormat = '###,##'
      EditFormat = '###,##'
    end
    object qryPreencheDBGridID_FORMA_PAGAMENTO: TStringField
    ...
    object qryPreencheDBGridFP: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'FP'
      Origin = 'DESCRICAO'
      ProviderFlags = []
    ...
    object qryPreencheDBGridID_CONTA_BANCARIA_CHEQUE: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'ID_CONTA_BANCARIA_CHEQUE'
      Origin = 'ID_CONTA_BANCARIA_CHEQUE'
      ProviderFlags = []
      ReadOnly = True
      Size = 36
    end
    object qryPreencheDBGridCHEQUE: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'CHEQUE'
    ...
    object qryPreencheDBGridID_CONTA_BANCARIA: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'ID_CONTA_BANCARIA'
      Origin = 'ID_CONTA_BANCARIA'
      ProviderFlags = []
      ReadOnly = True
      Size = 36
    end
    object qryPreencheDBGridID_CONTA_BANCARIA_1: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'ID_CONTA_BANCARIA_1'
      Origin = 'ID_CONTA_BANCARIA'
      ProviderFlags = []
      ReadOnly = True
      Size = 36
    end
    object qryPreencheDBGridCONTA: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'CONTA'
      Origin = 'CONTA'
      ProviderFlags = []
