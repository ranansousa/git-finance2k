...
begin
    ...
    if not uUtil.Empty(contaBancoORG.FID) then begin
       contaOrigem := contaBancoORG.Fconta;

      if not uUtil.Empty(contaBancoORG.FIDcontaContabil) then begin
...
begin
    ...
    if not uUtil.Empty(contaBancoDST.FID) then begin
         contaDestino := contaBancoDST.Fconta;

      if not uUtil.Empty(contaBancoDST.FIDcontaContabil) then begin
