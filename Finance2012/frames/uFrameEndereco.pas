...
// preenche os combos com todos os dados possiveis
  frmBairro1.createComboAll('BAIRRO','BAIRRO','BAIRRO', frmBairro1.cbbcombo, FsListaIdBairros);
  frmCidade1.createComboAll('CIDADE', 'CIDADE','CIDADE', frmCidade1.cbbcombo, FsListaIdCidades);
  frmEstado1.createComboAll('ESTADO','DESCRICAO','SIGLA', frmEstado1.cbbcombo, FsListaIdEstados);
