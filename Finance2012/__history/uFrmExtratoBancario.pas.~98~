...
begin
  ...
  if frmPeriodo1.validarPeriodo then begin
     ...
     if frmContaBancaria1.cbbConta.ItemIndex >0  then begin
       ...
       liberaRelatorio := liberaRelatorio + dmExtratoBancario.obterLancamentosCredito(idOrganizacao,idConta, frmPeriodo1.getDataInicial, frmPeriodo1.getDataFinal );
       liberaRelatorio := liberaRelatorio + dmExtratoBancario.obterLancamentosDebito(idOrganizacao,idConta, frmPeriodo1.getDataInicial, frmPeriodo1.getDataFinal );
