unit UDMTituloPagarBaixaAcrescimo;
...
type
  TdmTPBAcrescimo = class(TDataModule)
...
var
  dmTPBAcrescimo: TdmTPBAcrescimo;
...
procedure TdmTPBAcrescimo.inicializarDM(Sender: TObject);
begin
...
function TdmTPBAcrescimo.obterPorTPB(pIdOrganizacao, pIdTitutloPagarBaixa
  : String): Boolean;
begin
