...
CREATE TABLE CEDENTE (
    ...
    CODIGO                   VARCHAR(10)
    TIPO_CONTA_BANCARIA VARCHAR(1) DEFAULT 'C';
...
uses
  ...
  uOrganizacaoModel, uTipoCedenteModel;
...
type
  ...
  private
    ...
    function getFFtipoConta: string;
    procedure SetFtipoConta(const Value: string);
  ...
  public
    ...
    property FtipoConta: string read getFFtipoConta write SetFtipoConta;//poupanca/corrente/outra
...
function TCedenteModel.getFFtipoConta: string;
begin
Result := FFtipoConta;
end;
...
procedure TCedenteModel.SetFtipoConta(const Value: string);
begin
   FFtipoConta := Value;
end;
