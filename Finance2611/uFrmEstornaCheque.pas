...
begin
    ...
    begin
      ...
      begin
        ...
        PempecMsg.MsgInformation('O status do cheque é :  ' + cheque.FIDtipoStatus);
   ...
   msgStatusBar(1, ' Processo concluído com sucesso...');
  ...
  try
    ...
    begin
      ...
      if qryTPBBAIXA.RecordCount = 1 then begin
         ...
         PempecMsg.MsgWarning('O cheque foi utilizado para pagamento do título ' + qryTPBBAIXA.FieldByName('NUMERO_DOCUMENTO').AsString + #13 +
                              ' Utilize o botão CANCELAR BAIXA na tela de Cadastro de títulos a pagar. ');
          cheque.FID := '';
          sucesso := False;
      ...
      begin
        ...
        begin
          ...
          ' Você deve CANCELAR O LOTE PAGAMENTO. ');
           isLote := True;
        end
        else
        begin
          ...
          isLote := False;
          cheque.FID := '';
          PempecMsg.MsgWarning(' Não foi possível encontrar o LOTE PAGAMENTO. ');
    ...
    end else begin PempecMsg.MsgWarning(' Não foi possível estornar o cheque. '); end;
