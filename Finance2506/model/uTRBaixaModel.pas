...
type
  ...
  private
    ...
    procedure SetFFTRBaixaCheque(const Value: TTRBaixaChequeModel);
    procedure SetFFTRBaixaWWW(const Value: TTRBaixaInternetModel);
  ...
  public
    ...
    property FTRBaixaWWW        : TTRBaixaInternetModel read FFTRBaixaWWW     write SetFFTRBaixaWWW;
    property FTRBaixaCheque     : TTRBaixaChequeModel   read FFTRBaixaCheque  write SetFFTRBaixaCheque;
...
procedure TTRBaixaModel.SetFFTRBaixaCheque(const Value: TTRBaixaChequeModel);
begin
  FFTRBaixaCheque := Value;
end;

procedure TTRBaixaModel.SetFFTRBaixaWWW(const Value: TTRBaixaInternetModel);
begin
  FFTRBaixaWWW := Value;
end;
