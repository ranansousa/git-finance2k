...
begin
  ...
  Application.CreateForm(TfrmTransferenciasEntreContas, frmTransferenciasEntreContas);
  Application.CreateForm(TfrmRelatorioTransferencias, frmRelatorioTransferencias);
  Application.Run;
end.
