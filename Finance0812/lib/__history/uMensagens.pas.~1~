...
uses
  Vcl.Forms, Vcl.Dialogs, System.SysUtils, Windows;

   function msgErroUsuario(): String;
begin
  Result := 'O Usuário ou Senha digitados não foram validados.' + #13 + 'Verifique os dados digitados.';
end;

  function msgErroIPServerBD(): String;
begin
  Result := 'O IP do servidor não encontrado. Entre em contato com o Suporte.';
end;

  function msgErroNotServer(): String;
begin
  Result := 'Servidor não localizado. Entre em contato com o Suporte.';
end;
...
begin
 ...
 function msgErroOrganizacaoNula(): String;
begin
  Result := 'Ocorreu um erro ao tentar atribuir organização. Entre em contato com o Suporte.';
end;
...
function msgConsultaVazia(): String;
begin
  Result := ' A consulta solicitada não retornou resultados.' + #13 +
    ' Verifique os dados informados.';
end;

function msgExitApplication(): String;
begin
  Result := #13 + ' A Aplicação será encerrada. Obrigado!.';
end;

function msgErroLicencaFinance(): String;
begin
  Result := 'Não foi possível validar a licença. ';
end;
