...
type
  TfrmEnviaMail = class(TForm)
    ...
    procedure edtDestinoCopiaExit(Sender: TObject);
  ...
  public
    ...
    constructor Create (AOwner :TComponent; pAnexo, pAssunto :String);
...
constructor TfrmEnviaMail.Create(AOwner: TComponent; pAnexo, pAssunto: String);
begin
...
begin
  ...
  begin
    PempecMsg.MsgWarning('Sem conexão com servidor de e-mail');
...
procedure TfrmEnviaMail.edtDestinoCopiaExit(Sender: TObject);
begin
 copias.Add(edtDestinoCopia.Text);
end;
