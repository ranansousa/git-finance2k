...
begin
 ...
 idOrganizacao := TOrgAtual.getId;
  ...
  listaID.Add('Sem ID');
   ...
   qryObterTodos.Close;
   qryObterTodos := TContaBancariaChequeDAO.obterTodosPorContaBancaria(value);
   ...
   if not qryObterTodos.IsEmpty then begin
      ...
      begin
        combo.Items.Add(qryObterTodos.FieldByName('NUMERO_CHEQUE').AsString);
        listaID.Add(qryObterTodos.FieldByName('ID_CONTA_BANCARIA_CHEQUE').AsString);
        qryObterTodos.Next;
      end;
