 ...
 //obter os titulos pagos no lote
      ...
      //verificar se tem algum titulo pago já exportado
        ...
        begin
          ...
          continua := False;
          msgStatusBar(3, ' Não é possível cancelar o lote de pagamento.');
        ...
        begin
          ...
          begin
            msgStatusBar(3, 'O lote está sendo cancelado. Aguarde. ');
            ...
            begin
              ...
              begin
                ...
                loMostraErros.Clear;
                loMostraErros.Add('Títulos que não foi possível cancelar a baixa' + #13);
