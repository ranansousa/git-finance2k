...
soma :=0;
 //funcao para somar os valores dos centros de custos e fechar com o valor pago
  ...
  if soma <> value.FvalorPago  then begin
...
centroCusto : TTituloPagarCentroCustoModel;
 qtdRateioC, qtdRateioH, I :Integer;
percentRateio, valorSalvo, valorExtra, valorAC, valorDE, valorNominal, valorAntecipado :Currency;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            titulo.listaCustos[I].Fvalor := baixa.FvalorPago * percentRateio;

            if I = (titulo.listaCustos.Count - 1) then
            begin

              titulo.listaCustos[I].Fvalor := baixa.FvalorPago - valorSalvo;
         ...
         //  ajustaRateioCC(baixa); não ativado
        end;
