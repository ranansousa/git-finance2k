...
procedure TFrmRelatorioPagamentos.Button1Click(Sender: TObject);
begin
...
procedure TFrmRelatorioPagamentos.exibirRelatorio;
begin
...
function TFrmRelatorioPagamentos.retornarCaminhoRelatorio: string;
begin
