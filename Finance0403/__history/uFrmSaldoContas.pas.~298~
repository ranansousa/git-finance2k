...
uses
  ...
  FireDAC.Comp.Client, uFramePeriodo,   uContaBancariaDBModel, uContaBancariaDebitoDAO,
  frxClass, frxDBSet, frxExportCSV,uFrmMostraProcesso,
  uContaBancariaModel, uContaBancariaDAO, uContaBancariaCRModel, uContaBancariaCreditoDAO,
...
begin
 ...
 frmPeriodo1.inicializa(StartOfTheMonth(now ), EndOfTheMonth(now ) );
...
begin
 ...
 //fazer isso para o ano inteiro. A cada mes em separado
           ...
           vlrCR :=0; vlrDB :=0; vlrGlobal :=0; vlrSaldo :=0;
            ...
            if  (StrToInt(FormatDateTime('mm',frmPeriodo1.getDataFinal))) >= 1 then begin
            ...
            if  (StrToInt(FormatDateTime('mm',frmPeriodo1.getDataFinal))) >= 2 then begin
            ...
            if  (StrToInt(FormatDateTime('mm',frmPeriodo1.getDataFinal))) >= 3 then begin
            ...
            if  (StrToInt(FormatDateTime('mm',frmPeriodo1.getDataFinal))) >= 4 then begin
            ...
            if  (StrToInt(FormatDateTime('mm',frmPeriodo1.getDataFinal))) >= 5 then begin
           ...
           vlrCR :=0; vlrDB :=0; vlrSaldo :=0;
            ...
            if  (StrToInt(FormatDateTime('mm',frmPeriodo1.getDataFinal))) >= 6 then begin
            ...
            if  (StrToInt(FormatDateTime('mm',frmPeriodo1.getDataFinal))) >= 7 then begin
            ...
            if  (StrToInt(FormatDateTime('mm',frmPeriodo1.getDataFinal))) >= 8 then begin
            ...
            if  (StrToInt(FormatDateTime('mm',frmPeriodo1.getDataFinal))) >= 9 then begin
            ...
            if  (StrToInt(FormatDateTime('mm',frmPeriodo1.getDataFinal))) >= 10 then begin
            ...
            if  (StrToInt(FormatDateTime('mm',frmPeriodo1.getDataFinal))) >= 11 then begin
           ...
           if  (StrToInt(FormatDateTime('mm',frmPeriodo1.getDataFinal))) >= 12 then begin
