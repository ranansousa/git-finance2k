...
uses
  ...
  FireDAC.Comp.Client, Vcl.Grids, Vcl.DBGrids, Vcl.StdCtrls, cxContainer,uSacadoModel,
  ...
  EChkCNPJ, Vcl.ComCtrls, uFrameTipoSacado;
...
begin
     ...
     edtAgencia.Text         := sacadoModel.Fagencia;
     edtConta.Text           := sacadoModel.Fconta;
...
begin
 ...
 if deletar(sacadoModel) then begin
  ShowMessage('Sacado deletado com sucesso.');
 end;
 ...
 try
  //SALVADR ENDERECO
    ...
    // Salvar CONTATO
      ...
      sacado.Fagencia              := edtAgencia.Text;
      sacado.Fconta                := edtConta.Text;
      sacado.FIDbanco              := pIdBanco;
      sacado.Fnome                 := edtNomeSacado.Text;
      ...
      if salvar(sacado) then
      begin
        ShowMessage('Sacado salvo com sucesso.');
      end;
 ...
 try
   ...
   if UUTIL.Empty(sacadoModel.FID) then begin
    ...
    begin
      ...
      qrySalvar.ParamByName('PAGENCIA').AsString          := sacadoModel.Fagencia;
      qrySalvar.ParamByName('PCONTA').AsString            := sacadoModel.Fconta;
...
begin
 ...
 try
    ...
    if  not qryPesquisa.IsEmpty then begin
     ...
     sacado.Fagencia               := qryPesquisa.FieldByName('AGENCIA').AsString;
     sacado.Fconta                 := qryPesquisa.FieldByName('CONTA_BANCARIA').AsString;
        ...
        begin
          ...
          begin
                  ...
                  begin
                    ...
                    msgStatusBar(1, 'O sacado precisa ter conta contábil, endereço e contato. Verifique todas as abas');
                    Break
                  end;
