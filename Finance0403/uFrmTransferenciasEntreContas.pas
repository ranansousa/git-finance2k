            ...
            saldoConta := dmCBT.obterSaldoContaBancaria(pIDOrganizacao,FslistaIdContaOrigem[frmContaBancaria1.cbbConta.ItemIndex],  IncYear(Now, -25),cbbDataMovimento.Date);
              ...
              begin
                ...
                begin
                  ...
                  edtSaldoBancario.Text := 'O saldo da conta ' + frmContaBancaria1.cbbConta.Items[frmContaBancaria1.cbbConta.ItemIndex] + '  é  insuficiente. Se desejar prosseguir, confirme  aqui >>>! ';
