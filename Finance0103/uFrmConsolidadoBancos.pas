...
begin
  ...
  begin
    ...
    //obterTodosSaldos(idOrganizacao); desativado
     dxBtnImprimir.Enabled := False;
...
function TfrmConsolidadoBancos.obterTodosSaldos(pIdOrganizacao: string): Boolean;
var
...
begin
  ...
  if Assigned(frmMostraProcesso) then
  begin
    FreeAndNil(frmMostraProcesso);
  end;
  ...
  if qryObterTodasContas.RecordCount > 0 then
  begin
    dxBtnImprimir.Enabled := True;
    qryObterTodasContas.First;
...
function TfrmConsolidadoBancos.obterSaldoAnterior(pIdOrganizacao, pIDConta: string; pDataInicial, pDataFinal: TDate): Currency;
var
...
function TfrmConsolidadoBancos.obterSaldoPorContaDebito(pIdOrganizacao, pIDConta: string; pDataInicial, pDataFinal: TDate): Currency;
var
  valor: Currency;
  conta: TContaBancariaModel;
begin
...
function TfrmConsolidadoBancos.obterSaldoPorContaCredito(pIdOrganizacao, pIDConta: string; pDataInicial, pDataFinal: TDate): Currency;
var
  valor: Currency;
  conta: TContaBancariaModel;
begin
